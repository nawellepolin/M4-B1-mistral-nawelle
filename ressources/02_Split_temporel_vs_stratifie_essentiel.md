...
Schéma — le dataset est découpé en **6 blocs temporels fixes** ; à chaque fold,
le train gagne un bloc et le test glisse d'un cran vers le futur :
...
Le **TEST d'un fold devient le TRAIN du suivant**, et aucun test n'est jamais
*avant* son train (`.` = bloc pas encore utilisé dans ce fold).
